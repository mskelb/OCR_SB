...
### Dataset 
This dataset contains text line images (bin.png) and their corresponding ground truth (gt.txt). The data has been further divided into a training and a test set. <br/> 
