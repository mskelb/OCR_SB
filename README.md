...
### Dataset 
This dataset contain text line images (bin.png) and their corresponding ground truth (gt.txt). The dataset has been further divided into training and test sets. <br/> 
